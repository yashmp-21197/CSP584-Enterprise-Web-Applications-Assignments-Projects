...
public class Utilities extends HttpServlet{
	...
	public void printHeader(){
		...
		pw.print("<input type='text' name='search_id' value='' class='input' id='search_id' onkeyup='doCompletion()' autocomplete='off' placeholder='search Product here...' style='padding: 5px; font-size: 16px;'/>");
		pw.print("<div id='auto-row' style='padding-left: 400px;'>");
		pw.print("<table id='complete-table' style='width: 315px;'></table>");
		pw.print("</div>");
		pw.print("</div>");
		pw.print("</p>");
		pw.print("</div>");
