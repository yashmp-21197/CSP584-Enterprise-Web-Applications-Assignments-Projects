...
public class MySqlDataStoreUtilities
{
	...
	public static HashMap<String, Product> getProducts(){
		try 
		{
			...
			while(rs.next())
			{	Product p = new Product(rs.getString("id"),rs.getString("producttype"),rs.getString("productname"),rs.getDouble("productprice"),rs.getString("productimage"),rs.getString("productmanufacturer"),rs.getString("productcondition"),rs.getDouble("productdiscount"));
	...
	public static boolean updateOrderItem(int orderid, String productid, int productquantity){
		try
		{
			getConnection();
			Statement stmt=conn.createStatement();	
			String updateOrderItemQuery = "update orders set productquantity="+productquantity+" where orderid="+orderid+" and productid='"+productid+"';";
			stmt.executeUpdate(updateOrderItemQuery);
			return true;
		}
		catch(Exception e)
		{
	...
	public static boolean addProduct(Product p){
		...
		try{
			getConnection();
			String addProductQuery = "INSERT INTO Productdetails(id, producttype, productname, productprice, productimage, productmanufacturer, productcondition, productdiscount) "
			+ "VALUES (?,?,?,?,?,?,?,?);";
	...
	public static boolean updateProduct(Product p){
		...
		try{
			getConnection();
			String updateProductQuery = "UPDATE Productdetails SET producttype=?,productname=?,productprice=?,productimage=?,productmanufacturer=?,productcondition=?,productdiscount=? where id=?;";
