											...
											try{
												...
												if(days_diff >= 0){
													if(p.getCount() >= diff_productquantity){
														...
														boolean ret = MySqlDataStoreUtilities.updateProduct(p);
														OrderItem uoi = new OrderItem(oi.userid, oi.username, oi.useraddress, oi.creditcardno, oi.orderid, oi.purchasedate, oi.shipdate, oi.productid, oi.producttype, new_productquantity, oi.productprice, oi.shippingcost, oi.productdiscount, new_productquantity*(oi.shippingcost + (oi.productprice*(1.0-(oi.productdiscount/100.0)))), oi.storeid, oi.storeaddress, oi.iscancelled);
